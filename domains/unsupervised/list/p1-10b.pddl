(define (problem p1-10b)
  ...
  (:goal (and (at nlast) (visited n1) (not-visited n2) (visited n3) (not-visited n4)(visited n5)(not-visited n6)(visited n7)(not-visited n8)(visited n9)(not-visited n10)(not-visited nlast) ))
)
