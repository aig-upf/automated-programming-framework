(define (domain variables-output)
	...
	(:action inc-a
		...
		:effect (and (forall (?val1 ?val2 - value)
		                     (when (and (assignment a ?val1) (next ?val1 ?val2))
	...
	(:action dec-a
		...
		:precondition (and)
		:effect (and (forall (?val1 ?val2 - value)
		                     (when (and (assignment a ?val2) (next ?val1 ?val2))
	...
	(:action inc-b
		...
		:precondition (and)
		:effect (and (forall (?val1 ?val2 - value)
		                     (when (and (assignment b ?val1) (next ?val1 ?val2))
	...
	(:action dec-b
		...
		:precondition (and)
		:effect (and (forall (?val1 ?val2 - value)
		                     (when (and (assignment b ?val2) (next ?val1 ?val2))
	...
	(:action output-a-b
		...
		:effect (and
			     (forall (?val1 ?val2 - value)
		                     (when (and (assignment a ?val1) (assignment b ?val2))
		                           (and (output-two ?val1 ?val2)(not (not-output-two ?val1 ?val2)))))))
