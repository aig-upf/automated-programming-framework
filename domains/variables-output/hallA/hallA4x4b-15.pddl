...
;  	    a b c d - variable
  ...
  (:goal (and  
	 (output-two v0 v0)    (not-output-two v0 v1)(not-output-two v0 v2)(output-two v0 v3)
	 (not-output-two v1 v0)(not-output-two v1 v1)(not-output-two v1 v2)(not-output-two v1 v3)
	 (not-output-two v2 v0)(not-output-two v2 v1)(not-output-two v2 v2)(not-output-two v2 v3)
	 (output-two v3 v0)    (not-output-two v3 v1)(not-output-two v3 v2)(output-two v3 v3))))
