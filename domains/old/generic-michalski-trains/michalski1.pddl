...
(define (problem michalski-trains1)
	(:domain programming)
	(:objects
	...
	(:init
		...
		(includes-2ary shape c1 rectangle)
		...
		(includes-2ary wheels c3 v3)
		(includes-2ary wheels c4 v2)

		(includes-2ary load-type c1 square)
		(includes-2ary load-quantity c1 v3)
		(includes-2ary load-type c2 triangle)
		(includes-2ary load-quantity c2 v1)
		(includes-2ary load-type c3 hexagon)
		(includes-2ary load-quantity c3 v1)
		(includes-2ary load-type c4 circle)
