...
(define (problem michalski-trains9)
	(:domain programming)
	(:objects
	...
	(:init
		...
		(includes-2ary shape c2 rectangle)
		(includes-2ary shape c2 trapezoid)
