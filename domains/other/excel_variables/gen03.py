...
str_problem=""
str_problem=str_problem + "(DEFINE (PROBLEM REVERSE-"+str(name_size)+"-"+str(surname_size)+"-"+time.strftime("%d%m%Y%H%M%S")+")\n"
...
str_problem = str_problem + "\n\t( AND"
for idx in xrange( 0, surname_size ):
   str_problem = str_problem + "\n\t( ASSIGNMENT RES I" + str( idx ) + " " + str( generated_str2[ idx ] ) + " )"
str_problem = str_problem + "\n\t( ASSIGNMENT RES I" + str( surname_size ) + " SPACE )"
for idx in xrange( 0, name_size ):
   str_problem = str_problem + "\n\t( ASSIGNMENT RES I" + str( surname_size + 1 + idx ) + " " + str( generated_str[ idx ] ) + " )"
str_problem=str_problem + "\n\t)\n  )\n)"
