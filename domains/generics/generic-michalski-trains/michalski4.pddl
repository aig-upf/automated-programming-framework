...
(define (problem michalski-trains4)
	(:domain programming)
	(:objects
		has_car jagged infront shape load-type load-quantity wheels open closed long short double train - relation
		t1 c1 c2 c3 c4 
		none ushape trapezoid diamond square rectangle rectangle2 circle triangle hexagon
		v0 v1 v2 v3 - value
	)
	(:init
		;;;;;;;; V1.0 OF MICHALSKI
		...
		(includes-2ary shape c1 trapezoid)
		(includes-2ary shape c2 rectangle2)
		(includes-2ary shape c3 circle)
		(includes-2ary shape c4 rectangle)

		(includes-2ary wheels c1 v2)
		(includes-2ary wheels c2 v2)
		(includes-2ary wheels c3 v2)
		(includes-2ary wheels c4 v2)

		(includes-2ary load-type c1 triangle)
		(includes-2ary load-quantity c1 v1)
		(includes-2ary load-type c2 triangle)
		(includes-2ary load-quantity c2 v1)
		(includes-2ary load-type c3 diamond)
		(includes-2ary load-quantity c3 v1)
		(includes-2ary load-type c4 rectangle)
		(includes-2ary load-quantity c4 v1)
